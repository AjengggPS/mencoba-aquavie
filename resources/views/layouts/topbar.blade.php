<div class="bg-white shadow-md px-8 py-4 flex items-center justify-between relative">
    ...
    <div>
        ...
        <p class="text-sm text-gray-500">Selamat datang di {{ $pageTitle ?? 'Dashboard' }}</p>
    </div>
    ...
    <div class="flex items-center gap-4">
        ...
        <div class="relative">
            ...
            <div id="notificationDropdown" class="hidden absolute right-0 top-12 w-80 bg-white rounded-xl shadow-xl border border-gray-200 z-50">
                <div class="p-4 border-b border-gray-200">
                    <h3 class="text-gray-800 font-semibold">Notifikasi</h3>
                </div>
                <div class="max-h-96 overflow-y-auto">
                    <div class="p-4 border-b border-gray-100 hover:bg-gray-50 transition cursor-pointer">
                        <p class="text-gray-800 text-sm mb-1">pH kolam A mencapai level peringatan</p>
                        <p class="text-gray-500 text-xs">10 menit lalu</p>
                    </div>
                    <div class="p-4 border-b border-gray-100 hover:bg-gray-50 transition cursor-pointer">
                        <p class="text-gray-800 text-sm mb-1">Data berhasil disimpan</p>
                        <p class="text-gray-500 text-xs">1 jam lalu</p>
                    </div>
                    <div class="p-4 border-b border-gray-100 hover:bg-gray-50 transition cursor-pointer">
                        <p class="text-gray-800 text-sm mb-1">Suhu kolam B dalam kondisi optimal</p>
                        <p class="text-gray-500 text-xs">2 jam lalu</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="relative">
            ...
            >
                ...
                <div class="text-left">
                    <p class="text-sm text-gray-800 font-medium">Pembudidaya</p>
            ...
            <div id="profileDropdown" class="hidden absolute right-0 top-14 w-48 bg-white rounded-xl shadow-xl border border-gray-200 z-50">
                <a 
                    href="{{ route('profile') ?? '#' }}" 
                    class="flex items-center gap-3 px-4 py-3 hover:bg-gray-50 transition border-b border-gray-100 text-gray-700"
                ...
                <button 
                    ...
                    class="flex items-center gap-3 px-4 py-3 hover:bg-gray-50 transition w-full text-left border-0 bg-transparent cursor-pointer"
                >
